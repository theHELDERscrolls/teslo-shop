...
// Componente que implementa la página de login
...
export class LoginPage {
  ...
  // Se pone a true cuando falla el login, y se autodesactiva después de 2 segundos
  ...
  // Inyecta el router para navegar después del login exitoso
  router = inject(Router);

  // Inyecta el servicio de autenticación para realizar el login
  ...
  onSubmit() {
    // Valida que el formulario sea válido (email correcto, password con 6+ caracteres)
    ...
    // Realiza el login llamando al servicio de autenticación
